      ...
      <div className="bg-black w-full h-full lg:bg-opacity-50">
        <nav className="px-12 py-5">
          <img
            src="/images/logo.png"
            alt="logo"
            className="w-2/6 h-auto sm:w-[20%] "
          />

          <div className="flex justify-center ">
            <div className="bg-black bg-opacity-70 sm:px-16 sm:py-16 self-center mt-2  lg:w-3/5 lg:max-w-md rounded-md w-full md:flex md:flex-col md:items-center">
              <h2 className="text-white text-2xl sm:text-4xl mb-8 mt-10 sm:mt-0 font-semibold">
                {variant === "login" ? "Sign in" : "Register"}
              </h2>
              <div className="flex flex-col gap-4 w-full md:w-3/5 lg:w-full">
                {variant === "register" && (
                  <Input
                    label="Username"
